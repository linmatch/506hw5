...
```{r}
##Define a class called "poly"
setClass("poly",slots = c(coef="numeric",degree="numeric"))

##Define a constructor
make_poly <- function(coefficient, degree){
  degree<-length(coefficient)-1
...
setValidity("poly", function(object){
  ...
  else if(length(object@coef) != (object@degree + 1)){
    stop("Length of coefficient is not equal to degree+1")
  }
  return(TRUE)
})
```
